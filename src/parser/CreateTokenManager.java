/* Generated By:JavaCC: Do not edit this line. CreateTokenManager.java */
package parser;
import java.util.ArrayList;
import java.util.HashMap;

/** Token Manager. */
public class CreateTokenManager implements CreateConstants
{
...
/** Constructor. */
public CreateTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public CreateTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
